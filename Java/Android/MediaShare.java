/*
  ...
  Description: In theory it checks the phone for apps that can share
    and lets the user choose where to share a picture. Text to speech
    and voice recognition commands are added to this file.
*/
